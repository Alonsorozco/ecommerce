...
ActiveRecord::Schema.define(version: 2021_10_01_004136) do
  ...
  create_table "order_items", force: :cascade do |t|
    ...
    t.index ["variants_id"], name: "index_order_items_on_variants_id"
  end
  ...
  add_foreign_key "order_items", "variants", column: "variants_id"
